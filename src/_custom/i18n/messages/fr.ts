...
export const fr: I18nLanguage = {
  ...
  QUERY: 'Requête',
  QUERY_PARAM: 'Paramètre',
  QUERY_STRING: 'Requête',
  RECEIPT_PRODUCT_COMPONENT: 'Composant de produit BR',
  ARRAY: 'Array',
  BOOLEAN: 'Boolean',
  NUMBER: 'Number',
  STRING: 'String',
  ...
  FLOOR: 'Étage',
  CITY: 'Ville',
  CONSTRUCTION_END_AT: 'Fin de construction',
  CONSTRUCTION_START_AT: 'Début de construction',
  TAX_ID: 'IF',
  ...
  PRODUCT_PRICING: 'Prix produit',
  PRODUCT_PRICINGS: 'Prix des produits',
  ...
  ADDRESS: 'Adresse',
  APPLICATED_AT: 'Date application',
  BID_PRICE_INCL_TAX: "Prix d'achat TTC",
  ...
  COMPANY: 'Société',
  DESIRED_DELIVERY_DATE: 'Livr. souhaitée le',
  ...
  'ERROR_PAGE.TITLE':
    '{code, select, 403 {Permissions insuffisantes} 404 {Page non trouvée} other {Erreur système}}.',
  ...
  'SAFELY_UNGUESSABLE.DESCRIPTION':
    'Protection modérée contre le scénario de hachage lent hors ligne',
  ...
  'FILTER.TITLE':
    "{count, plural, =0 {Aucune condition de filtre n'est appliquée} other {Afficher les enregistrements...}}",
  WHERE: 'Où',
  AND: 'Et',
  OR: 'Ou',
  //
  ...
  WORK_ORDER_MUST_BE_PENDING:
    "L'ordre de travail doit être en cours pour ajouter des interventions",
  ...
  'VALIDATION.OBJECT.NO_UNKNOWN':
    "Ne peut pas avoir de clés non spécifiées dans la forme de l'objet",
  ...
  'VALIDATION.STRING.PASSWORD_INCORRECT': 'Mot de passe incorrect',
