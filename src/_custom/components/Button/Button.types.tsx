...
export type ButtonProps = {
  variant?: ButtonVariant
    | 'outline-default' | 'outline-primary' | 'outline-success' | 'outline-info' | 'outline-warning' | 'outline-danger' | 'outline-dark' | 'outline-secondary'
    | 'facebook' | 'google' | 'twitter' | 'instagram' | 'youtube' | 'linkedin'
    | 'link' | 'flush'
    | 'color-muted'
