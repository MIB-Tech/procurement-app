            ...
            <div className='d-flex flex-stack flex-grow-1'>
              <div className='fw-bold'>
                <div className='fs-6 text-gray-600'>
                  ...
                  <a href='src/app/pages/accounts/components/settings/cards/ConnectedAccounts#' className='fw-bolder'>
                    Learn More
                  </a>
                </div>
              </div>
            ...
            <div className='d-flex flex-stack'>
              <div className='d-flex'>
                ...
                <div className='d-flex flex-column'>
                  <a href='src/app/pages/accounts/components/settings/cards/ConnectedAccounts#' className='fs-5 text-dark text-hover-primary fw-bolder'>
                    Google
                  </a>
