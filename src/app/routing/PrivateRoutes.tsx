...
export const CUSTOM_ROUTES: Array<CustomRoute> = [
  ...
  },
  {
    ...
    granted: [RoleKeyEnum.SuperAdmin, RoleKeyEnum.Admin, RoleKeyEnum.Viewer,RoleKeyEnum.Treso,RoleKeyEnum.Finances],
  ...
  },
  {
    ...
    granted: [RoleKeyEnum.SuperAdmin, RoleKeyEnum.Admin, RoleKeyEnum.Referent,RoleKeyEnum.Treso,RoleKeyEnum.Finances],
