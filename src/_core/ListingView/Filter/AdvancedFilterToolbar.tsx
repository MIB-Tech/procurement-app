...
const AdvancedFilterToolbar = <M extends ModelEnum>({
  onChange,
  modelName,
  columns,
  value,
  className,
}: AdvancedFilterProps<M>) => {
                      ...
                      {filters.map((filter, index) => {
                        ...
                        return (
                          <div
                            ...
                            className='row mb-3'
                          >
                            <div className='col-2 d-flex align-items-center justify-content-end fs-bolder text-gray-600'>
                            ...
                            <div className='col-10 row g-0 pe-3'>
                              <div className='col-3'>
                                <SelectField
                                  ...
                                  onChange={(option) => {
                                    const _columnMapping = getColumnMapping({
                                      modelName,
                                      columnName: option,
                                    });
                              ...
                              <div
                                className={clsx(
                                  isValueless(operator) ? "col" : "col-3"
                                )}
                              >
                                <SelectField
