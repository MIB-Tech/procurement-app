...
import {
  JsonldErrorCreateResponse,
  JsonldSuccessCreateResponse,
} from "./hydra.types";
...
>;
export type ValidationSchemaDef<M extends ModelEnum> = Record<
  keyof Model<M> | string,
  Pick<FormViewBaseColumn<M>, "required"> & TypeColum
>;
