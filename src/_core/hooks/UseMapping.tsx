...
export const getSearchableColumns = <M extends ModelEnum>({
  modelName,
  ignoreNested,
}: {
  modelName: M;
  ...
  return columNames.reduce((columnNames, currentColumnName) => {
    ...
    switch (def.type) {
      case ColumnTypeEnum.String:
        switch (def.format) {
          ...
          case StringFormat.Qrcode:
            return [...columnNames, currentColumnName];
        }
        return columnNames;
      ...
      default:
        ...
        //const nestedSearchableColumns: Array<keyof Model<any> | string> =
