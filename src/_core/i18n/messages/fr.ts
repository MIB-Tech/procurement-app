...
export const fr: I18nLanguage = {
  ...
  "VALIDATION.PURCHASE_ORDER_PRODUCT.QUANTITY":
    "Doit être égale à la somme des quantités livrées",
  ...
  "SOMEWHAT_GUESSABLE.DESCRIPTION":
    "Protection contre les attaques en ligne non contrôlées",
  "TOO_GUESSABLE.DESCRIPTION": "Mot de passe risqué",
  "VERY_GUESSABLE.DESCRIPTION":
    "Protection contre les attaques en ligne limitées",
  ...
  "CONTACT.COUNT":
    "{count, plural, =0 {Aucun contact} one {Un contact} other {# contacts}}",
  "ASSET_MODEL.COUNT":
    "{count, plural, =0 {Aucun modèle} one {Un modèle} other {# modèles}}",
  ...
  "VALIDATION.MIXED.NO_ONE_OF":
    "Ne doit pas être l'une des valeurs suivantes: {values}",
  ...
  "VALIDATION.STRING.MATCHES":
    "Doit correspondre aux éléments suivants: '{regex}'",
  ...
  TENANT: "Clinique/Projet",
  TENANTS: "Cliniques/Projets",
