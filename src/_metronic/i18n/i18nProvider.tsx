...
setLocale({
  ...
  string : {
    ...
    lowercase: (props)=>({id: 'VALIDATION.STRING.LOWERCASE', params: props}),
    uppercase: (props)=>({id: 'VALIDATION.STRING.UPPERCASE', params: props}),
  },
  date : {
  ...
  object: {
    noUnknown: (props) => ({ id: 'VALIDATION.OBJECT.NO_UNKNOWN', params: props })
  },
  array: {
